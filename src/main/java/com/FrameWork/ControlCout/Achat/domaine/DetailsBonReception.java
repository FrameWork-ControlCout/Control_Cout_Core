...
@Entity
@Table(name = "Details_Bon_Reception", schema = "param_achat")
@Audited
@AuditTable("Details_Bon_Reception_AUD")
@Getter
@Setter
public class DetailsBonReception {
    ...
    @Column(name = "Code_Bon_Reception", insertable = false, updatable = false)
