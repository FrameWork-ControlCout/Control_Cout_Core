...
public class FicheTech {
    ...
    @Column(name = "Autre_Cout", nullable = false, columnDefinition = ("decimal(18,3)"))
    private BigDecimal autreCout;

    @Column(name = "Pourcent_Autre_charge", nullable = false, columnDefinition = ("decimal(18,3)"))
    private BigDecimal pourcentAutreAcharge;

//    @Column(name = "Nbre_Pers_Ref", nullable = false, columnDefinition = ("decimal(18,3)") )
//    private BigDecimal nbrePersRef;
    @Column(name = "Nbre_Pers_Ref", nullable = false)
